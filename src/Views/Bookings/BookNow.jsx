            ...
            <div className="w-[100%] rounded-2xl  h-[100%] overflow-y-auto">
                <Formik 
                    ...
                    onSubmit={(values) => {
                        ...
                        formData.append('source_address', JSON.stringify(SendData.source_address))
                        formData.append('destination_address', JSON.stringify(SendData.destination_address))
                        ...
                        formData.append('items_type', SendData.items_type)
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            ...
                            <div className="h-[300px] bg-slate-50 rounded-2xl p-5">
                                <div className="grid gap-1 gap-x-4 sm:grid-cols-2">
                                    <div className="relative">
                                        <label htmlFor="name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Sender Name</label>
                                        <Field type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Senders Name" required="" />
                                        <KErrorMessage name="name" />
                                    </div>   
                                    <div className="relative">
                                        <label htmlFor="r_name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Receivers Name</label>
                                        <Field type="text" name="r_name" id="r_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Receivers Name" required="" />
                                        <KErrorMessage name="r_name" />
                                    </div>
                                    <div className="relative">
                                        <label htmlFor="phone_number" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Sender Phone Number</label>
                                        <Field type="text" name="phone_number" id="phone_number" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Senders Phone Number" required="" />
                                        <KErrorMessage name="phone_number" />
                                    </div>
                                    <div className="relative">
                                        <label htmlFor="r_phone_number" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Receivers Phone Number</label>
                                        <Field type="text" name="r_phone_number" id="r_phone_number" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Receivers Phone Number" required="" />
                                        <KErrorMessage name="r_phone_number" />
                                    </div>
                                    <div className="relative">
                                        <label htmlFor="email" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Sender Email Address</label>
                                        <Field type="text" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Senders Email Address" required="" />
                                        <KErrorMessage name="email" />
                                    </div> 
                                    
                                    <div className="relative">
                                        <label htmlFor="r_email" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Receivers Email Address</label>
                                        <Field type="text" name="r_email" id="r_email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Receivers Email Address" required="" />
                                        <KErrorMessage name="r_email" />
                                    </div> 
                                    <div className="relative">
                                        <label htmlFor="address" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Sender Address</label>
                                        <Field type="text" name="address" id="address" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Senders Address" required="" />
                                        <KErrorMessage name="address" />
                                    </div> 
                                    
                                    <div className="relative">
                                        <label htmlFor="r_address" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Receivers Address</label>
                                        <Field type="text" name="r_address" id="r_address" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Receivers Address" required="" />
                            ...
                            <div className="h-[300px] bg-slate-50 rounded-2xl p-5">
                                <div className="grid gap-1 mb-4 sm:grid-cols-2">
                                    <div className="relative">
                                        <label htmlFor="items_type" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Truck Item Type </label>
                                        <Field type="text" as="select" name="items_type" id="items_type" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                                    ...
                                    <div className="relative">
                                        <label htmlFor="items" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Items</label>
                                        <Field type="text" name="items" id="items" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Items Separated by Comas" required="" />
                                        <KErrorMessage name="items" />
                                    </div>
                                    <div className="relative">
                                        <label htmlFor="weight" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Weight</label>
                                    ...
                                    <div className="relative">
                                        <label htmlFor="pickup_date" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Pickup Date</label>
                                        <Field type="date" name="pickup_date" id="pickup_date" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Pickup Date" required="" />
                            ...
                            <div className="h-[450px] w-[30%] bg-slate-50 rounded-2xl p-5">
                                <div className="h-[90%] w-[100%]">
                                    <div className="text-left">
                                        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white" htmlFor="file_input"> Add Images</label>
                                        <input onChange={handleImageChange} name="image" multiple className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" />
                                ...
                                <div className="flex items-center justify-start">
                                    ...
                                    <button type="button" className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Nest</button>
                                    <PrimaryButtonLoader isloading={false} text="Create Order" type="submit" />
                                </div>
                            </div>
                        </div>
                    </Form>
